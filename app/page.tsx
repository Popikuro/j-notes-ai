  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full overflow-hidden bg-slate-950 flex items-center justify-center border-b border-slate-800">
        ...
        <div className="relative z-10 container max-w-7xl mx-auto px-6 pt-8 pb-8 lg:pt-12 lg:pb-8 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 text-white">
          {/* Left Column: Text */}
          <div className="w-full lg:w-[55%] text-center lg:text-left z-20">
            <div className="inline-flex items-center justify-center lg:justify-start gap-2 px-3 py-1.5 mb-6 text-[11px] font-bold uppercase tracking-widest text-cyan-400 bg-cyan-950/40 border border-cyan-800/50 rounded-full shadow-sm backdrop-blur-sm">
              <span className="text-sm leading-none" role="img" aria-label="Japan">{"\u{1F1EF}\u{1F1F5}"}</span>
          ...
          <div className="w-full lg:w-[40%] flex items-center justify-center relative group mt-16 lg:mt-0 z-10 lg:translate-x-4">
