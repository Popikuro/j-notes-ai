...
export default function Footer() {
    return (
        <footer className="border-t border-slate-200 dark:border-slate-800 mt-0 pt-6 pb-10">
            <div className="container mx-auto max-w-7xl px-6 flex flex-col items-center justify-center text-center text-sm text-slate-500 font-outfit">
                ...
                <div className="mb-6">
                    <a href="https://x.com/JNotes_AI" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full bg-black px-6 py-2.5 text-sm font-bold text-white transition-all duration-300 border border-slate-800 hover:border-indigo-500 hover:shadow-[0_0_20px_rgba(99,102,241,0.6)] dark:bg-black dark:text-white dark:hover:border-indigo-400 dark:hover:shadow-[0_0_20px_rgba(129,140,248,0.6)]">
                ...
                <div className="mb-6 flex items-center justify-center w-full text-sm md:text-base font-bold text-slate-700 dark:text-slate-200 font-inter tracking-wide gap-4 md:gap-6">
                    ...
                    <span className="opacity-30 font-normal text-xs md:text-sm">•</span>
                    <a href="/about" className="hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline underline-offset-4 transition-all duration-300">
                        About
                    </a>
                    <span className="opacity-30 font-normal text-xs md:text-sm">•</span>
                ...
                <p className="text-xs text-slate-500 mt-2 text-center">
                    As an Amazon Associate, J-Notes AI earns from qualifying purchases.
                </p>
            </div>
        </footer>
    );
