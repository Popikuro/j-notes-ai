    ...
    return (
        <footer className="border-t border-slate-200 dark:border-slate-800 py-10 mt-0">
            <div className="container mx-auto max-w-5xl px-6 flex flex-col items-center justify-center text-center text-sm text-slate-500 font-outfit">
                <div className="relative h-16 w-16 mb-10 overflow-hidden rounded-full border border-indigo-500/20 shadow-sm bg-slate-100 dark:bg-slate-800">
                ...
                <div className="mb-10 flex items-center justify-center gap-12 text-sm md:text-base font-bold text-slate-700 dark:text-slate-200 font-inter tracking-wide">
