...
export function NewsletterSignup() {
    ...
    return (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl px-6 md:px-10 text-center max-w-3xl mx-auto shadow-2xl relative overflow-hidden flex flex-col items-center justify-center min-h-[320px]">
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center gap-8">
                ...
                <div className="w-full flex flex-col items-center justify-center gap-2 pt-0 mt-0">
                    ...
                    <h3 className="text-4xl md:text-[42px] font-black font-inter text-white leading-[1.1] tracking-tight -mt-6 mb-0">
                        Master the nuance implicitly.
                    </h3>
                    <p className="text-lg md:text-[22px] text-slate-200 font-outfit max-w-2xl mx-auto leading-tight mt-0 mb-0">
                        Join 2,500+ professionals receiving weekly AI-decoded breakdowns of Japanese business etiquette.
                    </p>
                </div>

                {/* Form Block */}
                <div className="w-full md:w-auto flex justify-center mt-0">
                    {status === "success" ? (
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 w-full max-w-md relative">
                            ...
                            <button
                                type="submit"
                                disabled={status === "loading"}
                                className="bg-indigo-600 hover:bg-indigo-500 text-white rounded-full px-6 py-2 font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-70 text-sm tracking-wide"
                            >
